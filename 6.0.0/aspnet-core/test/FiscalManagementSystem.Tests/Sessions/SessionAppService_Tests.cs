...
using Shouldly;
using Xunit;
using FiscalManagementSystem.Sessions;

namespace FiscalManagementSystem.Tests.Sessions
{
    public class SessionAppService_Tests : FiscalManagementSystemTestBase
    {
