namespace FiscalManagementSystem.Configuration
{
	...
	public static class AppSettings
	{
		...
		public static class InBoxMailServer
		{
			public const string HostName = "InBoxMailServer.HostName";
			public const string Port = "InBoxMailServer.Port";
			public const string UseSSL = "InBoxMailServer.UseSSL";
			public const string Protocol = "InBoxMailServer.Protocol";
			public const string Login = "InBoxMailServer.Login";
			public const string Password = "InBoxMailServer.Password";
			public const string LastConnectResult = "InBoxMailServer.LastConnectResult";
		}

		public static class PowerBI
		{
			public const string PowerBIUrl = "PowerBI.Url";
		}
	}
}